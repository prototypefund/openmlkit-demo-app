...
class TestResizeTallImageBothDimensionsGrow {
    ...
    fun widthGrowsWithLargerRatio_resultStillTall() {
        ...
        val expected = ResizeConfig(ratio = 2.0, padRight = 5, padBottom = 0)
    ...
    fun widthGrowsWithLargerRatio_resultSquare() {
        ...
        val expected = ResizeConfig(ratio = 2.0, padRight = 10, padBottom = 0)
    ...
    fun widthGrowsWithLargerRatio_resultWide() {
        ...
        val expected = ResizeConfig(ratio = 2.0, padRight = 20, padBottom = 0)
...
class TestResizeTallImageBothDimensionShrink {
    ...
    fun widthShrinksWithLargerRatio() {
        ...
        val expected = ResizeConfig(ratio = 0.25, padRight = 0, padBottom = 20)
    ...
    fun heightShrinksWithLargerRatio_resultStillTall() {
        ...
        val expected = ResizeConfig(ratio = 0.5, padRight = 5, padBottom = 0)
    ...
    fun heightShrinksWithLargerRatio_resultWide() {
        ...
        val expected = ResizeConfig(ratio = 0.25, padRight = 10, padBottom = 0)
...
class TestResizeTallImageWidthGrowsHeightShrinks {
    ...
    fun resultStillTall() {
        ...
        val expected = ResizeConfig(ratio = 0.5, padRight = 15, padBottom = 0)
    ...
    fun resultSquare() {
        ...
        val expected = ResizeConfig(ratio = 0.5, padRight = 20, padBottom = 0)
...
class TestResizeTallImageWidthShrinksHeightGrows {
    ...
    fun test() {
        ...
        val expected = ResizeConfig(ratio = 0.5, padRight = 0, padBottom = 40)
